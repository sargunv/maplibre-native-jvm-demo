...
// These functions may not be available on all platforms
// Provide stub implementations for platforms that don't have them
static void glInvalidateFramebuffer_stub(GLenum, GLsizei, const GLenum*) {
    // No-op stub - framebuffer invalidation is an optimization hint
}

static void glInvalidateSubFramebuffer_stub(GLenum, GLsizei, const GLenum*, GLint, GLint, GLsizei, GLsizei) {
    // No-op stub - framebuffer invalidation is an optimization hint
}

void (*const glInvalidateFramebuffer)(GLenum, GLsizei, const GLenum*) = glInvalidateFramebuffer_stub;
void (*const glInvalidateSubFramebuffer)(GLenum, GLsizei, const GLenum*, GLint, GLint, GLsizei, GLsizei) = glInvalidateSubFramebuffer_stub;
