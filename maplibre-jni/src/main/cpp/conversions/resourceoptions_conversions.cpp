...
namespace maplibre_jni
{
    ...
    void ResourceOptionsConversions::init(JNIEnv *env)
    {
        ...
        jclass localClass = env->FindClass("org/maplibre/kmp/native/ResourceOptions");
        if (!localClass)
        {
        ...
        tileServerOptionsField = env->GetFieldID(resourceOptionsClass, "tileServerOptions", "Lorg/maplibre/kmp/native/TileServerOptions;");
        ...
        constructor = env->GetMethodID(resourceOptionsClass, "<init>",
                                       "(Ljava/lang/String;Lorg/maplibre/kmp/native/TileServerOptions;Ljava/lang/String;Ljava/lang/String;J)V");
        if (!constructor)
        {
